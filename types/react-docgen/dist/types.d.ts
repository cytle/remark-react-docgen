...
export type PropTypeDescriptor = {
  name: "arrayOf" | "custom" | "enum" | "array" | "bool" | "func" | "number" | "object" | "string" | "any" | "element" | "node" | "symbol" | "objectOf" | "shape" | "exact" | "union" | "elementType";
  value?: any;
  raw?: string;
  computed?: boolean;
...
export type FlowTypeDescriptor = FlowSimpleType | FlowLiteralType | FlowElementsType | FlowFunctionSignatureType | FlowObjectSignatureType;
...
export type Resolver = (node: ASTNode, parser: Parser) => (NodePath | null | undefined) | (Array<NodePath> | null | undefined);
